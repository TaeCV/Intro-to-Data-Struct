...
namespace CP {
    ...
    protected:
        ...
        protected:
            ...
            void to_next_data() {
                while (mCurBucketItr != mEndBucketItr &&
                    ...
                    mCurBucketItr++;
                    if (mCurBucketItr == mEndBucketItr)
                        break;
        ...
        public:
            ...
            hashtable_iterator(ValueIterator element, BucketIterator bucket, BucketIterator endBucket) : mCurValueItr(element), mCurBucketItr(bucket), mEndBucketItr(endBucket) {
                to_next_data();
            }
